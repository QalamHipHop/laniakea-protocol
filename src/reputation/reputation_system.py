...
class ReputationSystem:
    ...
    def register_node(self, node_id: str) -> bool:
        ...
        self.node_histories[node_id] = NodeHistory(
            node_id=node_id,
            created_at=time()
        )
    ...
    def _calculate_diversity_score(self, history: NodeHistory) -> float:
        ...
        """
        total_dimensions = 6  # knowledge, computation, originality, consciousness, environmental, health
    ...
    def detect_suspicious_behavior(self, node_id: str) -> List[str]:
        ...
        recent_events = [
            e for t, e, m in history.events
            if time() - t < 3600  # آخرین ساعت
        ]
