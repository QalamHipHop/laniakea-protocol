...
class Exchange:
    ...
    def _match_orders(self, order_book: OrderBook, new_order: Order):
        ...
        # سفارشات مقابل
        opposite_orders = (
            order_book.sell_orders if new_order.order_type == OrderType.BUY
...
class LiquidityPool:
    ...
    def add_liquidity(
        ...
        print(f"➕ Liquidity added: {amount_a:.2f} {self.dimension_a}, {amount_b:.2f} {self.dimension_b}")
        return shares
    ...
    def remove_liquidity(
        ...
        print(f"➖ Liquidity removed: {amount_a:.2f} {self.dimension_a}, {amount_b:.2f} {self.dimension_b}")
