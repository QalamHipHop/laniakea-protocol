...
![Version](https://img.shields.io/badge/Version-6.0.0--Mainnet-7c3aed?style=for-the-badge)
...
![Status](https://img.shields.io/badge/Status-Live_Mainnet-10b981?style=for-the-badge)
![Network](https://img.shields.io/badge/Network-Mainnet-00bfff?style=for-the-badge)
![Uptime](https://img.shields.io/badge/Uptime-99.9%25-06b6d4?style=for-the-badge)
![Routes](https://img.shields.io/badge/API-187%2B_routes-7c3aed?style=for-the-badge)
...
## 🌐 Production Status — v6.0.0-Mainnet

| Metric | Value |
|---|---|
| **Version** | `6.0.0-Mainnet` |
| **Network mode** | `mainnet` |
| **Chain ID** | `1` |
| **Live URL** | https://laniakea-protocol.onrender.com |
| **API** | 187+ routes across 35 subsystems |
| **UI** | Unified Cosmic Interface v6 (`/web/cosmic_v6.html`) |
| **LLM providers** | groq → openai → anthropic → openrouter → ollama → pollinations → stub |
| **WebSocket** | `/ws/global/laniakea-v6` (auto-reconnect) |
| **Docs** | `/docs` (Swagger UI), `/redoc`, `/openapi.json` |
| **Auth** | JWT + MFA (`LANIAKEA_AUTH_ENABLED=true` in prod) |
| **Persistence** | SCDA snapshot → `data/scda_snapshot.json` |

The unified SPA exposes **18 subsystems** behind one shell:
SCDA · Blockchain · Metaverse 8D · AI/LLM · Knowledge Market · NFT ·
DeFi · Governance · Diplomacy · Social Hub · Cross-Chain · Quantum ·
Self-Evolution · Simulation · Achievements · Observability · Web3/Wallet ·
API Explorer.

Every panel hits a live API endpoint. The hero shows real subsystem
counters that update every 15s; the `8D Hypercube` and metaverse
`Fibonacci-sphere` canvases animate from real projection code.
