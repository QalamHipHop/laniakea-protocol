...
class TestLanding:
    ...
    def test_landing_links_to_cosmic_ui(self):
        html = (WEB_DIR / "landing.html").read_text()
        # v5 unified dashboard is the canonical link target;
        # legacy cosmic.html is still kept as a sibling dashboard.
        assert ("cosmic_v5.html" in html) or ("cosmic.html" in html)
