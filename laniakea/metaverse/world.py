...
class Avatar:
    ...
    def __init__(self, did: str, name: str, position: Vector3 = None):
        self.did = did
        self.name = name
...
class Region:
    ...
    def __init__(
        self, region_id: str, name: str, size: Tuple[float, float, float] = (1000, 1000, 1000)
    ):
        ...
        # قوانین
        self.rules = {"allow_flying": True, "allow_building": True, "pvp_enabled": False}
    ...
    def get_nearby_avatars(self, position: Vector3, radius: float) -> List[Avatar]:
...
class MetaverseWorld:
    ...
    def create_avatar(self, did: str, name: str, spawn_region: str) -> Optional[Avatar]:
        """ایجاد آواتار"""
    ...
    def teleport_avatar(self, did: str, target_region: str, target_position: Vector3) -> bool:
        """تلپورت آواتار"""
    ...
    def interact(self, avatar_did: str, entity_id: str) -> Optional[Dict]:
        """تعامل با موجودیت"""
...
class SocialSpace:
    ...
    def send_message(self, room_id: str, sender_did: str, message: str) -> Dict:
        """ارسال پیام"""
        if room_id not in self.chat_rooms:
        ...
        msg = {"room_id": room_id, "sender": sender_did, "message": message, "timestamp": time()}

        return msg

    def create_event(
        self, event_id: str, title: str, region_id: str, start_time: float, duration: float
    ):
