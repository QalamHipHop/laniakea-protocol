...
class SingleCellDigitalAccount:
    ...
    NOTE: This is the legacy implementation. The new SCDA class is in scda.py.
    """
...
# --- Backward-compatible aliases (white-paper compatibility) ---------------
SingleCellDigitalAccount_Legacy = SingleCellDigitalAccount

__all__ = [
    "SingleCellDigitalAccount",
    "SingleCellDigitalAccount_Legacy",
